...
We previously recommended [{`remotes`} package](https://remotes.r-lib.org/), `remotes::install_github("Public-Health-Scotland/slfhelper")` still works but there have been issues reported with it failing to properly install dependencies.
