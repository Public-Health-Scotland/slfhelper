...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("Public-Health-Scotland/slfhelper", fork = TRUE)`.
...
Please note that the slfhelper project is released with a [Contributor
Code of
Conduct](https://public-health-scotland.github.io/slfhelper/CODE_OF_CONDUCT.md).
