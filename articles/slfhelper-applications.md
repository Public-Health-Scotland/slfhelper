...
Produce a table to compare A&E Attendances for the following age groups
(0-17, 18-64, 65-74, 75-84, 85+) for 2018/19 in East Lothian HSCP.
...
Create a table to compare the number of outpatient attendances (SMR00)
broken down by specialty and gender in 2017/18 in Scotland.
...
Produce a table to compare the number of admissions, bed days and
average length of stay (split into elective and non-elective) by Health
Board of Residence in 2018/19.
...
### GP Out of Hours Consultations in South Ayrshire.

Create a table showing the number of GP Out of Hours consultations for
patients with dementia in South Ayrshire HSCP in 2019/20 broken down by
...
Produce a table to show the number of patients and the total costs for
Aberdeen City HSCP in 2018/19. Include a breakdown of costs for the
following services: Acute (inpatients & daycases), GLS, Mental Health
and Maternity, Outpatients, A&E, GP Out of Hours, Community Prescribing.
...
### Deaths from Dementia / Alzheimer’s

Produce a chart to show the number of deaths from 2015/16 to 2019/20 in
Scotland where the main cause of death was recorded as
Dementia/Alzheimer’s (ICD 10 codes: G30, F01-F03, F05.1).
...
Create a table to compare the number and cost of prescribed items for
patients with Multiple Sclerosis (MS) by HSCP in 2018/19. Include the
number of dispensed items and cost per patient.
...
### A&E attendance in the last 3 months of life.

Produce a table to show the number of deaths in Glasgow City HSCP in
2019/20 and what proportion had an A&E attendance in the last 3 months
of life.
...
Create a table showing the number of non-elective admissions with any
part of the stay (Continuous Inpatient Journey, CIJ) in the specialty
Geriatric Medicine, by HSCP in 2019/20. Also include the associated bed
days, cost and number of patients.
...
# we want to keep earliest admission and latest discharge, keep flag if any episode was in spec AB
