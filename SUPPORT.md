# Getting help with slfhelper

Thanks for using slfhelper! Before filing an issue, there are a few
...
- If it’s a question: start with [the SLF Teams
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/Public-Health-Scotland/slfhelper/issues/new).

- If you’re not sure: feel free to do either!

Before opening a new issue, be sure to [search issues and pull
requests](https://github.com/Public-Health-Scotland/slfhelper/issues) to
make sure the bug hasn’t been reported and/or already fixed in the
